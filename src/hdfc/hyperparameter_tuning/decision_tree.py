...
file_handler = logging.FileHandler(os.path.join(log_dir, 'decision_tree.log'))
...
def tune_model():
    ...
    param_grid = params["decision_tree"]
    ...
    with mlflow.start_run():
        ...
        joblib.dump(best_model, os.path.join(model_path, "decision_tree.pkl"))
